...
class HZMainOneKeyListenCell: UICollectionViewCell {
    private var oneKeyListen:[HZOneKeyListenModel]?
    ...
    private lazy var gridView: UICollectionView = {
        ...
        collectionView.register(HZOneKeyListenCell.self, forCellWithReuseIdentifier: "HZOneKeyListenCell")
...
extension HZMainOneKeyListenCell: UICollectionViewDelegate, UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return self.oneKeyListen?.count ?? 0
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell:HZOneKeyListenCell = collectionView.dequeueReusableCell(withReuseIdentifier: "OneKeyListenCell", for: indexPath) as! HZOneKeyListenCell
